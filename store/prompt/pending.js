...
// import PromptState from '@/util/prompt-state'
...
export const actions = prompt.createActions({ promptBpEndpoint: 'pending' });

export const getters = prompt.createGetters();

// export const state = () => new PromptState()
...
//   async FETCH(ctx, { status = '', withReviews = false }) {
